                ...
                <div class="p-6 pt-0">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="group relative rounded-lg border border-white/30 px-3 pb-1.5 pt-2.5 transition duration-200 focus-within:border-sky-200 focus-within:ring focus-within:ring-sky-300/30">
                            <label for="name" class="text-xs font-medium text-gray-400 group-focus-within:text-white">Name</label>
                        ...
                        <div class="mt-4 group relative rounded-lg border border-white/30 px-3 pb-1.5 pt-2.5 transition duration-200 focus-within:border-sky-200 focus-within:ring focus-within:ring-sky-300/30">
                            <label for="apellido" class="text-xs font-medium text-gray-400 group-focus-within:text-white">Last name</label>
                            <input id="apellido" type="text" name="apellido" value="{{ old('apellido') }}" placeholder="Last name" required autocomplete="apellido"
                                class="block w-full border-0 bg-transparent p-0 text-sm text-white placeholder:text-zinc-500 focus:outline-none focus:ring-0 sm:leading-7" />
                        </div>
                        <x-input-error :messages="$errors->get('apellido')" class="mt-2 text-xs text-rose-300" />

                        <div class="mt-4 group relative rounded-lg border border-white/30 px-3 pb-1.5 pt-2.5 transition duration-200 focus-within:border-sky-200 focus-within:ring focus-within:ring-sky-300/30">
                            <label for="email" class="text-xs font-medium text-gray-400 group-focus-within:text-white">Email</label>
                        ...
                        <div class="mt-4 group relative rounded-lg border border-white/30 px-3 pb-1.5 pt-2.5 transition duration-200 focus-within:border-sky-200 focus-within:ring focus-within:ring-sky-300/30">
                            <label for="password_confirmation" class="text-xs font-medium text-gray-400 group-focus-within:text-white">Confirm password</label>
                            <input id="password_confirmation" type="password" name="password_confirmation" required autocomplete="new-password"
                                class="block w-full border-0 bg-transparent p-0 text-sm text-white placeholder:text-zinc-500 focus:outline-none focus:ring-0 sm:leading-7" />
                        </div>
                        <x-input-error :messages="$errors->get('password_confirmation')" class="mt-2 text-xs text-rose-300" />

                        <div class="mt-4 flex items-center justify-end gap-x-2">
                            <a href="{{ route('login') }}" class="inline-flex h-10 items-center justify-center rounded-md px-4 py-2 text-sm font-medium transition duration-200 hover:bg-white/10 hover:ring hover:ring-white/40">
                                Login
                            </a>
