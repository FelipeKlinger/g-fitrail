	...
	<div class="w-full space-y-12 pb-12">
		<section class="relative overflow-hidden rounded-3xl border border-white/10 bg-zinc-950">
			...
			<div class="relative grid grid-cols-1 gap-8 p-8 lg:grid-cols-2 lg:p-12">
				<div class="flex flex-col justify-center">
					<span class="w-fit rounded-full border border-violet-400/30 bg-violet-500/10 px-3 py-1 text-xs font-medium uppercase tracking-widest text-violet-200">
					...
					<p class="mt-4 max-w-xl text-sm text-zinc-300 sm:text-base">
						...
						Este preview muestra cómo se vería la homepage principal del gimnasio con contenido dinámico.
					</p>
				...
				<div class="overflow-hidden rounded-2xl border border-white/10 bg-zinc-900">
					<img src="https://images.unsplash.com/photo-1534438327276-14e5300c3a48?auto=format&fit=crop&w=1400&q=80"
		...
		<section id="planes" class="space-y-6">
			<div class="flex flex-col justify-between gap-3 md:flex-row md:items-end">
				...
				<p class="max-w-xl text-sm text-zinc-400">Precios y beneficios de ejemplo para mostrar la estructura de una sección comercial.</p>
			</div>

			<div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
				<article class="rounded-2xl border border-white/10 bg-zinc-900 p-6">
					<h3 class="text-lg font-semibold text-white">Plan Starter</h3>
					<p class="mt-1 text-sm text-zinc-400">Perfecto para iniciar</p>
					<p class="mt-4 text-3xl font-semibold text-white">$19<span class="text-sm text-zinc-400">/mes</span></p>
					...
					<button class="mt-6 w-full rounded-xl border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white transition hover:border-violet-400/40 hover:bg-violet-500/10">Seleccionar</button>
				</article>

				<article class="rounded-2xl border border-violet-400/40 bg-gradient-to-b from-violet-500/20 to-zinc-900 p-6 shadow-[0_0_40px_rgba(139,92,246,0.25)]">
					<p class="w-fit rounded-full border border-violet-300/40 bg-violet-500/20 px-2.5 py-1 text-xs text-violet-100">Más popular</p>
					...
					<p class="mt-4 text-3xl font-semibold text-white">$39<span class="text-sm text-zinc-300">/mes</span></p>
					...
					<button class="mt-6 w-full rounded-xl border border-violet-400/40 bg-violet-500/20 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-violet-500/30">Elegir Pro</button>
				</article>

				<article class="rounded-2xl border border-white/10 bg-zinc-900 p-6">
					<h3 class="text-lg font-semibold text-white">Plan Elite</h3>
					<p class="mt-1 text-sm text-zinc-400">Experiencia premium</p>
					<p class="mt-4 text-3xl font-semibold text-white">$59<span class="text-sm text-zinc-400">/mes</span></p>
					<ul class="mt-5 space-y-2 text-sm text-zinc-300">
						<li>• Entrenador personal 1:1</li>
						<li>• Nutrición y seguimiento semanal</li>
						<li>• Zona recovery incluida</li>
					</ul>
					<button class="mt-6 w-full rounded-xl border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white transition hover:border-violet-400/40 hover:bg-violet-500/10">Solicitar demo</button>
				</article>
			</div>
		</section>

		<section id="clases" class="space-y-6">
			<div>
				<p class="text-sm text-violet-300">Entrenamientos</p>
				<h2 class="text-3xl font-semibold text-white">Clases destacadas de la semana</h2>
			</div>
		...
		<section class="space-y-6">
			...
			<div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
				<article class="rounded-2xl border border-white/10 bg-zinc-900 p-6">
					...
					<p class="mt-3 text-sm text-zinc-400">Guía visual con distribución de proteína, carbohidratos y grasas saludables para recuperación.</p>
					<a href="#" class="mt-4 inline-block text-sm font-medium text-violet-300 hover:text-violet-200">Leer tip</a>
				</article>
				...
				<article class="rounded-2xl border border-white/10 bg-zinc-900 p-6">
					...
					<p class="mt-3 text-sm text-zinc-400">Estrategia semanal para subir cargas sin perder técnica ni comprometer la movilidad.</p>
					<a href="#" class="mt-4 inline-block text-sm font-medium text-violet-300 hover:text-violet-200">Leer tip</a>
				</article>
				...
				<article class="rounded-2xl border border-white/10 bg-zinc-900 p-6">
					...
					<p class="mt-3 text-sm text-zinc-400">Checklist nocturno para mejorar recuperación, consistencia y energía durante el día.</p>
					<a href="#" class="mt-4 inline-block text-sm font-medium text-violet-300 hover:text-violet-200">Leer tip</a>
				</article>
			</div>
		</section>
		...
		<section class="rounded-3xl border border-violet-400/30 bg-gradient-to-r from-violet-500/20 via-purple-500/10 to-fuchsia-500/20 p-8 text-center sm:p-10">
			...
			<p class="mx-auto mt-3 max-w-2xl text-sm text-zinc-200 sm:text-base">
				Crea tu cuenta, reserva tu primera clase y vive una experiencia de entrenamiento diseñada para resultados sostenibles.
			</p>
