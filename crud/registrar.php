...
<body>
    ...
    <form method="post">
        ...
        <label>Peso (Kg) <input type="number" name="peso" required></label><br>
        ...
        <select name="objetivo" required>
            ...
            <option value="Ganar masa muscular (superávit calórico)">Ganar masa muscular (superávit calórico)</option>
