...
export function ParticleHero() {
  ...
  return (
    ...
    >
      ...
      {/* Hero */}
      <div
        className="hero mx-auto max-w-3xl flex justify-center mt-60 h-[300px] border-gray-700/50 relative"
      ...
      >
        Plataforma digital para la gestión integral de un gimnasio
      </p>
      ...
      <div
        style={{
          ...
          gap: "3em",
          opacity: 0,
          animation: "load 2s ease-out 3.2s forwards, up 1.4s ease-out 3.2s forwards",
          padding: "0 2em",
          justifyContent: "center",
        }}
      >
        <div style={{ textAlign: "center" }}>
          <p style={{ fontSize: "0.9em", color: "#98c0ef", fontWeight: 600, margin: 0 }}>Felipe</p>
          <p style={{ fontSize: "0.75em", color: "#7ba8d8", margin: "0.3em 0 0" }}>Backend Lead</p>
        </div>
        <div style={{ textAlign: "center" }}>
          <p style={{ fontSize: "0.9em", color: "#98c0ef", fontWeight: 600, margin: 0 }}>Felipe y Andres</p>
          <p style={{ fontSize: "0.75em", color: "#7ba8d8", margin: "0.3em 0 0" }}>Frontend & UX</p>
        </div>
        <div style={{ textAlign: "center" }}>
          <p style={{ fontSize: "0.9em", color: "#98c0ef", fontWeight: 600, margin: 0 }}>Oscar y Daniel</p>
          <p style={{ fontSize: "0.75em", color: "#7ba8d8", margin: "0.3em 0 0" }}>DB & DevOps</p>
        </div>
        <div style={{ textAlign: "center" }}>
          <p style={{ fontSize: "0.9em", color: "#98c0ef", fontWeight: 600, margin: 0 }}>Felipe</p>
          <p style={{ fontSize: "0.75em", color: "#7ba8d8", margin: "0.3em 0 0" }}>API Integrations</p>
        </div>
        <div style={{ textAlign: "center" }}>
          <p style={{ fontSize: "0.9em", color: "#98c0ef", fontWeight: 600, margin: 0 }}>Oscar y Daniel</p>
          <p style={{ fontSize: "0.75em", color: "#7ba8d8", margin: "0.3em 0 0" }}>Documentación</p>
        </div>
      </div>
